...
import com.versobit.kmark.clarity.BuildConfig;
import com.versobit.kmark.clarity.R;

public final class AboutDialog extends DialogFragment {

    public static final String FRAGMENT_TAG = "fragment_diag_about";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView txtNotice = (TextView)v.findViewById(R.id.dialog_about_notice);
        ...
        txtNotice.setMovementMethod(new DonateLinkMovementMethod());
        ...
        return new AlertDialog.Builder(getActivity(), getTheme())
                .setView(v)
                .setPositiveButton(R.string.dialog_about_dismiss, new DialogInterface.OnClickListener() {
                    @Override
    ...
    private class DonateLinkMovementMethod extends LinkMovementMethod {
        @Override
